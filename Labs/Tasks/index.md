...
- Welcome to the **Elcon Tasks** section.
- Each folder below contains hands-on tasks/exercises that you can complete independently to practice specific skills.
- Tasks include a clear scenario, helpful hints, and detailed solutions.
- Follow the README file in each task category for detailed instructions.
