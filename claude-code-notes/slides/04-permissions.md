...
## Slide: The three rule behaviors
...
## Slide: Where rules live - settings.json
...
## Slide: Tool-scoped rules and matchers
...
## Slide: Allowlists and reducing prompts
...
## Slide: Safe defaults and the trust prompt
