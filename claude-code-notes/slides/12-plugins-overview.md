...
## Slide: The five things a plugin can bundle
...
## Slide: How plugins layer with the rest of config
...
## Slide: When to build a plugin (vs. plain config)
